...
class WeatherManager
    ...
    def to_string
        ...
        for weather in @weather_daily do
            ...
            result_string += "Minimum : #{change_fahrenheit_to_celsius(weather["MinValue"], weather["MinUnit"])}°C\n"
            result_string += "Maximum : #{change_fahrenheit_to_celsius(weather["MaxValue"], weather["MaxUnit"])}°C\n"
